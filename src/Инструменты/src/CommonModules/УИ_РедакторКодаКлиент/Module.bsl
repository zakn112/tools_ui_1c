...
//			ДокументView.setOption("generateSnippetEvent", Истина);
			...
			КонецЕсли;
			ПараметрыРедактора.КнопкиКонтекстногоМенюРедактораИнициализированы = Истина;
		КонецЕсли;
...
Процедура ДобавитьПунктМеню(ДокументView, ПараметрыРедактора, Идентификатор, Наименование)	
	Если Не ПараметрыРедактора.КнопкиКонтекстногоМенюРедактораИнициализированы Тогда	
