...
// * КнопкиМенюРедактора - Соответствие - пользовательские пункты контекстного меню редактора, где:
...
Функция НовыйДанныеРедактораФормы() Экспорт
	...
	ДанныеРедактора.Вставить("КнопкиМенюРедактора", Новый Соответствие);
